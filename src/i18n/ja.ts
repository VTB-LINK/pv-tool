...
export const ja: Record<LocaleKey, string> = {
  ...
  'font_family': 'フォント Font',
  'load_local_fonts': 'ローカルフォントを取得',
  'font_custom_input': 'カスタム入力',
  'font_missing_title': 'フォント不足',
  'font_missing_message': 'テンプレートで使用されているフォントが見つかりません。代替フォントで表示されます',
  'font_action_keep': '保持',
  'font_action_replace': '置換',
  'font_action_reset': 'デフォルトに戻す',
  ...
  // Color swatch titles
  'canvas_custom': 'カスタム',
  'canvas_custom_color': 'カスタムキャンバス色',
