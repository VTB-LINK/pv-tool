...
export const en: Record<LocaleKey, string> = {
  ...
  // Panel titles
  'postfx': 'Post FX',
  'font_lock': 'Lock font (preserve on template switch)',
  'font_reset': 'Reset',
  ...
  'font_custom_input': 'Custom Input',
  'font_missing_title': 'Font Missing',
  'font_missing_message': 'The font used by this template is not available and will be rendered with a fallback',
  'font_action_keep': 'Keep',
  'font_action_replace': 'Replace',
  'font_action_reset': 'Reset to Default',
